...
static int __init hello_init(void)
{
    ...
    printk("%s %s line %d\n", __FILE__, __FUNCTION__, __LINE__);
    major = register_chrdev(0, "hello_drv", &hello_drv_fops);  

    /* 辅助操作：让内核自动创建设备节点 /dev/hello_drv */
    ...
    device_create(hello_class, NULL, MKDEV(major, 0), NULL, "hello_drv"); /* /dev/hello_drv */
...
/* 7. 其他完善：提供设备信息，自动创建设备节点，获得虚拟地址等 */
